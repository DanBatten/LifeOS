  ...
  const shoes = [
    {
      ...
      status: 'active',
      is_primary: true,
      image_url: '/shoes/adidas-adios-pro-4.png',
    ...
    },
    {
      ...
      status: 'active',
      is_primary: true,
      image_url: '/shoes/adidas-adizero-evo-sl.png',
      notes: 'Lightstrike Pro foam. Good for tempo and easy runs.',
    },
    {
      user_id: USER_ID,
      brand: 'ASICS',
      ...
      status: 'active',
      is_primary: true,
      image_url: '/shoes/asics-gel-nimbus.png',
