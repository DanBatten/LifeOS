...
// NOTE: Garmin real-time tools are available in @lifeos/garmin package
// Disabled here because spawning Python process per call is too slow for real-time use
// To re-enable: import from @lifeos/garmin and uncomment getGarminHealthTools() in getHealthTools()
